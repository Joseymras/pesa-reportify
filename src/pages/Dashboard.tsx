...
import { BarChart3, Copy, Download, FileText, List, LogOut, Plus, Share2, User } from "lucide-react";
...
const Dashboard = () => {
  ...
  const copyReportToClipboard = () => {
    ...
    reportText += `Total Contributed: Ksh ${totalContributed.toLocaleString('en-US', {minimumFractionDigits: 2})}\n\n`;
    reportText += "Contributors:\n";
    
    parsedTransactions.forEach(transaction => {
      reportText += `${transaction.name}: Ksh ${transaction.amount.toLocaleString('en-US', {minimumFractionDigits: 2})}\n`;
    });
                      ...
                      <Card className="mt-6">
                        ...
                        <CardContent>
                          ...
                          <div className="flex justify-center gap-4">
                            ...
                            <Button variant="outline" className="gap-2" onClick={copyReportToClipboard}>
